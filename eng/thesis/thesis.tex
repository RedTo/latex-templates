...
\usepackage{amssymb}
\usepackage{graphicx}
\usepackage[font=small]{caption} % sehr klein
\usepackage{subcaption}
\usepackage{picinpar}


%opening
\def\ThesisTitle{Performance estimation and optimization of the IEEE802.11 MAC layer for long distance point-to-point links}
\def\ThesisAuthor{Michael Rademacher}
\def\ThesisLocation{Sankt Augustin}
\def\ThesisType{Master}
\def\ThesisPubDate{January 15,2014}
...
\def\ThesisExternalCompany{Fraunhofer-Institut fuer \\ Offene Kommunikationssysteme}
\def\ThesisSubject{}

\interfootnotelinepenalty=10000

\usepackage{todonotes}
\usepackage{pdfpages} % pdf Dokumente direkt einbindenw
\usepackage{algorithmic} % pseudo-code
\usepackage{blindtext}
%\usepackage{slashbox}
\usepackage[printonlyused]{acronym} 
% neuer Tabellentyp centriert und feste breite
\newcolumntype{C}[1]{>{\centering\arraybackslash}p{#1}}

\newcommand{\specialcell}[2][l]{%
  \begin{tabular}[#1]{@{}c@{}}#2\end{tabular}}
% Einstellen der Größe der Beschriftungen über Tabellen und Abbildungen
%\usepackage[font=footnotesisze]{caption} % sehr klein
\usepackage[]{acronym}
